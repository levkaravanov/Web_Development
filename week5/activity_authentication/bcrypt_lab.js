...
// Function to demonstrate synchronous hashing
...
// Main execution
async function main() {
    console.log('=== Part 1: Understanding How bcrypt Works ===\n');

    console.log('1. Hashing a password:');
    await hashPassword();

    console.log('\n2. Comparing passwords (will show incorrect since we use dummy hash):');
